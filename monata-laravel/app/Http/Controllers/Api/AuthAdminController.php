...
class AuthAdminController extends Controller
{
     ...
     */
    public function getProfile(): AdminResource
    {
     ...
     * @return \App\Http\Resources\AdminResource The updated admin user instance.
     */
    public function updateProfile(UpdateProfileRequest $request): AdminResource
    {
